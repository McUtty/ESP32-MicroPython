...
class Chirp:
    def __init__(self, sclPin, sdaPin, address=0x20):
        self.sclPin = sclPin
        self.sdaPin = sdaPin
        self.i2c = I2C(scl=Pin(self.sclPin), sda=Pin(self.sdaPin), freq=30000)
    ...
    def reset(self):
        """Reset the sensor"""
        # To reset the sensor, write 6 to the device I2C address.
        self.i2c.writeto_mem(0x20, 0x06, b'0')
    ...
    def getaddress(self):
        """Read the i2c adress"""
        return self._register_8(GET_ADDRESS)
